...
function(e, t, s) {
    ...
    var Q, G, H, F, N, O, q, j, V, _, K, J, X, Y, Z, ee = (Q = /^([\d\.]+)(em|vw|px)$/, G = k((function(e) {
            ...
            var s;
            if (!(e in z))
                if (z[e] = !1, t && (s = e.match(Q))) z[e] = s[1] * C[s[2]];
                else try {
    ...
    function ie(e, t) {
        var s, r, i;
        if (e && t)
            for (i = c.parseSet(t), e = c.makeUrl(e), s = 0; s < i.length; s++)
                if (e === c.makeUrl(i[s].url)) {
                    r = i[s];
                    break
                }
        return r
    ...
    e.console && console.warn, v in o || (v = "src"), A["image/jpeg"] = !0, A["image/gif"] = !0, A["image/png"] = !0, A["image/svg+xml"] = t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), c.ns = ("pf" + (new Date).getTime()).substr(0, 9), c.supSrcset = "srcset" in o, c.supSizes = "sizes" in o, c.supPicture = !!e.HTMLPictureElement, c.supSrcset && c.supPicture && !c.supSizes && (H = t.createElement("img"), o.srcset = "data:,a", H.src = "data:,a", c.supSrcset = o.complete === H.complete, c.supPicture = c.supSrcset && c.supPicture), c.supSrcset && !c.supSizes ? (F = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", O = function() {
        2 === N.width && (c.supSizes = !0), i = c.supSrcset && !c.supSizes, a = !0, setTimeout(se)
    }, (N = t.createElement("img")).onload = O, N.onerror = O, N.setAttribute("sizes", "9px"), N.srcset = F + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 9w", N.src = F) : a = !0, c.selShort = "picture>img,img[srcset]", c.sel = c.selShort, c.cfg = m, c.DPR = T || 1, c.u = C, c.types = A, c.setSize = u, c.makeUrl = k((function(e) {
        ...
        return e.cands || (e.cands = function(e, t) {
            ...
            var r, i, n, c, a, u = e.length,
                o = 0,
                l = [];

            function f() {
                var e, s, n, c, a, u, o, f, d, p = !1,
                    A = {};
            ...
            function d() {
                for (s(M), n = "", c = "in descriptor";;) {
                    if (a = e.charAt(o), "in descriptor" === c)
                        if (W(a)) n && (i.push(n), n = "", c = "after descriptor");
                        else {
                            if ("," === a) return o += 1, n && i.push(n), void f();
                            if ("(" === a) n += a, c = "in parens";
                            else {
        ...
        if (!(e in b) || m.uT) {
            var t = c.calcLength(function(e) {
                var t, s, r, i, n, a, u, o = /^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i,
                    l = /^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i;
                for (r = (s = function(e) {
                        var t, s = "",
                            r = [],
                    ...
                    if (u = n = (i = s[t])[i.length - 1], o.test(u) && parseFloat(u) >= 0 || l.test(u) || "0" === u || "-0" === u || "+0" === u) {
        ...
        var t;
        if (e)
            for (var s = 0, r = (t = c.parseSet(e)).length; s < r; s++) te(t[s], e.sizes);
        return t
    }, c.setRes.res = te, c.applySetCandidate = function(e, t) {
        if (e.length) {
            var s, r, i, n, a, u, o, l, f, d, p, A, h, w, S, x, y = t[c.ns],
                E = c.DPR;
            if (u = y.curSrc || t[v], (o = y.curCan || function(e, t, s) {
                    var r;
                    return !s && t && (s = (s = e[c.ns].sets) && s[s.length - 1]), (r = ie(t, s)) && (t = c.makeUrl(t), e[c.ns].curSrc = t, e[c.ns].curCan = r, r.res || te(r, r.set.sizes)), r
                }(t, u, e[0].set)) && o.set === e[0].set && ((f = g && !t.complete && o.res - .1 > E) || (o.cached = !0, o.res >= E && (a = o))), !a)
                for (e.sort(re), a = e[(n = e.length) - 1], r = 0; r < n; r++)
                    if ((s = e[r]).res >= E) {
        ...
        for (t = 0; t < n.length && !i; t++)
            if ((s = n[t]).srcset && c.matchesMedia(s.media) && (r = c.supportsType(s.type))) {
                "pending" === r && (s = r), i = s;
                break
            }
        return i
    }, c.parseSets = function(e, t, s) {
        var r, n, a, u, o = t && "PICTURE" === t.nodeName.toUpperCase(),
            p = e[c.ns];
        ...
        }, p.sets.push(n), (a = (i || p.src) && w.test(p.srcset || "")) || !p.src || ie(p.src, n) || n.has1x || (n.srcset += ", " + p.src, n.cands.push({
            url: p.src,
            d: 1,
            set: n
        }))) : p.src && p.sets.push({
    ...
    }, c.supPicture ? (se = u, c.fillImg = u) : (J = e.attachEvent ? /d$|^c/ : /d$|^c|^i/, X = function() {
        var e = t.readyState || "";
        Y = setTimeout(X, "loading" === e ? 200 : 999), t.body && (c.fillImgs(), (q = q || J.test(e)) && clearTimeout(Y))
    }, Y = setTimeout(X, t.body ? 9 : 99), Z = p.clientHeight, $(e, "resize", (j = function() {
        E = Math.max(e.innerWidth || 0, p.clientWidth) !== C.width || p.clientHeight !== Z, Z = p.clientHeight, E && c.fillImgs()
    }, 99, K = function() {
        var e = new Date - _;
        e < 99 ? V = setTimeout(K, 99 - e) : (V = null, j())
    }, function() {
        _ = new Date, V || (V = setTimeout(K, 99))
    })), $(t, "readystatechange", X)), c.picturefill = se, c.fillImgs = se, c.teardownRun = u, se._ = c, e.picturefillCFG = {
        pf: c,
        push: function(e) {
            var t = e.shift();
    ...
    e.picturefill = se, "object" == typeof module && "object" == typeof module.exports ? module.exports = se : "function" == typeof define && define.amd && define("picturefill", (function() {
        return se
        ...
        return r.onerror = function() {
            ...
            A[t] = 1 === r.width, se()
        }, r.src = "data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA==", "pending"
    }("image/webp"))
}(window, document);